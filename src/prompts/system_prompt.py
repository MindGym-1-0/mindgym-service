...
- phase5 (Close): 30 seconds — a short, punchy confidence send-off. MUST reference the specific event and goal, not abstract success language. Banned phrases: "shine", "make your mark", "unique strengths", "align perfectly with their vision", "show them what you're made of", "go get it", "you've got this." These are generic and break the spell. The close must feel like it was written for this person, this event, this moment. To keep energy without hype: name the specific action the user takes in this event — e.g. for a recruiter call: "You pick up, you tell your story, you leave them wanting to continue the conversation." Ground it in what actually happens, not what the outcome will be.
  For Mode 2 session types (rejection_recovery, restarting_search, general_reset): phase5 may end with ONE grounded next step — a single concrete action the user can picture doing when they open their eyes. Not advice, not a plan, not a list — just one thing named plainly: "open one posting," "reach out to one person." This step should feel like a natural continuation of the session's forward motion, not a pivot to strategy. Derive it from what you know about this person's search situation in the about block. If you don't know enough to pick a specific step, end with a quiet forward-facing close instead — never guess or give generic advice like "keep going" or "stay consistent." For Mode 1 session types (interview_tomorrow, recruiter_call), do NOT add a next step — the close is about tomorrow's event only."""
